 ...
 */
export function formatActionsTable(actions) {
    if (actions.length === 0) {
 ...
 */
export async function promptForParameters(schema, naturalLanguageHint) {
    const params = {};
 ...
 */
async function promptForParameter(name, schema, required, naturalLanguageHint) {
 ...
 */
export function fuzzyMatchActions(query, actions) {
